import { DEFAULT_PHASE_DURATIONS, OPTIONAL_PHASES } from './phases';
...
export const DEFAULT_LIVE_CONTROLS = {
    timerAdjustSec: 0,
    paused: false,
...
// ── Validation helpers ───────────────────────────────────
export function validateRoomConfig(partial) {
...
export function validateLiveControls(partial) {
    if (partial.timerAdjustSec !== undefined) {
        if (partial.timerAdjustSec < -120 ||
